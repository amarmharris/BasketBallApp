...
*@viewId:nw.epm.refapps.st.prod.manage.new::sap.suite.ui.generic.template.ListReport.view.ListReport::SEPMRA_C_PD_Product
*/
sap.ui.define([
	...
	function (
		...
		"use strict";
		return ControllerExtension.extend("my.manage.products.mycontroller", {
			...
			// 	 * @memberOf my.manage.products.mycontroller
			// 	 */
			// 	onInit: function() {
			// 	},
