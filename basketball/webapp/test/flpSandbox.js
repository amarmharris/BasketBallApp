		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#BasketballData-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"BasketballData-display": {
								"semanticObject": "BasketballData",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.amar.basketball",
									"url": sap.ui.require.toUrl("com/amar/basketball")
								}
							}
						}
					}
